...
/**
 * @internal
 * CreateOrgTeamDto without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$CreateOrgTeamDto = {
  appIconLogo?: string | undefined;
  appLogo?: string | undefined;
  autoAcceptCreator?: boolean | undefined;
  bannerUrl?: string | undefined;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object CreateOrgTeamDto
 */
const SchemaIn$CreateOrgTeamDto: z.ZodType<
  CreateOrgTeamDto, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$CreateOrgTeamDto
 */
const SchemaOut$CreateOrgTeamDto: z.ZodType<
  External$CreateOrgTeamDto, // output type of this zod object
  z.ZodTypeDef,
  CreateOrgTeamDto // the object to be transformed
> = z
  .object({
    appIconLogo: z.string().optional(),
    appLogo: z.string().optional(),
...
export const Schemas$CreateOrgTeamDto = {
  in: SchemaIn$CreateOrgTeamDto,
  out: SchemaOut$CreateOrgTeamDto,
};
