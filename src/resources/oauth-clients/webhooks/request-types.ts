...
/**
 * @internal
 * DeleteAllRequest without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$DeleteAllRequest = {
  clientId: string;
};

/**
 * Takes network data, validates it, and transforms keys to match typescript object DeleteAllRequest
 */
const SchemaIn$DeleteAllRequest: z.ZodType<
  DeleteAllRequest, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$DeleteAllRequest
 */
const SchemaOut$DeleteAllRequest: z.ZodType<
  External$DeleteAllRequest, // output type of this zod object
  z.ZodTypeDef,
  DeleteAllRequest // the object to be transformed
> = z
  .object({
    clientId: z.string(),
  })
...
export const Schemas$DeleteAllRequest = {
  in: SchemaIn$DeleteAllRequest,
  out: SchemaOut$DeleteAllRequest,
};
