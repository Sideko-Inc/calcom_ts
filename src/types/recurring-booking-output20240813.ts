 ...
 */
export type RecurringBookingOutput20240813 = {
  absentHost: boolean;
  attendees: Attendee[];
  /**
...
/**
 * @internal
 * RecurringBookingOutput20240813 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$RecurringBookingOutput20240813 = {
  absentHost: boolean;
  attendees: External$Attendee[];
  bookingFieldsResponses: Record<string, any>;
  cancellationReason?: string | undefined;
  cancelledByEmail?: string | undefined;
  createdAt: string;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object RecurringBookingOutput20240813
 */
const SchemaIn$RecurringBookingOutput20240813: z.ZodType<
  RecurringBookingOutput20240813, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
    absentHost: z.boolean(),
    attendees: z.array(Schemas$Attendee.in),
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$RecurringBookingOutput20240813
 */
const SchemaOut$RecurringBookingOutput20240813: z.ZodType<
  External$RecurringBookingOutput20240813, // output type of this zod object
  z.ZodTypeDef,
  RecurringBookingOutput20240813 // the object to be transformed
> = z
  .object({
    absentHost: z.boolean(),
    attendees: z.array(Schemas$Attendee.out),
    bookingFieldsResponses: z.record(z.string(), z.any()),
    cancellationReason: z.string().optional(),
    cancelledByEmail: z.string().optional(),
    createdAt: z.string(),
...
export const Schemas$RecurringBookingOutput20240813 = {
  in: SchemaIn$RecurringBookingOutput20240813,
  out: SchemaOut$RecurringBookingOutput20240813,
};
