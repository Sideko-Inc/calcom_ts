 ...
 */
export type CreateInstantBookingInput20240813 = {
  attendee: Attendee;
  /**
...
/**
 * @internal
 * CreateInstantBookingInput20240813 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$CreateInstantBookingInput20240813 = {
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object CreateInstantBookingInput20240813
 */
const SchemaIn$CreateInstantBookingInput20240813: z.ZodType<
  CreateInstantBookingInput20240813, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$CreateInstantBookingInput20240813
 */
const SchemaOut$CreateInstantBookingInput20240813: z.ZodType<
  External$CreateInstantBookingInput20240813, // output type of this zod object
  z.ZodTypeDef,
  CreateInstantBookingInput20240813 // the object to be transformed
> = z
  .object({
...
export const Schemas$CreateInstantBookingInput20240813 = {
  in: SchemaIn$CreateInstantBookingInput20240813,
  out: SchemaOut$CreateInstantBookingInput20240813,
};
