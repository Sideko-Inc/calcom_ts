 ...
 */
export type CreateEventTypeInput20240614 = {
  /**
...
/**
 * @internal
 * CreateEventTypeInput20240614 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$CreateEventTypeInput20240614 = {
  afterEventBuffer?: number | undefined;
  beforeEventBuffer?: number | undefined;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object CreateEventTypeInput20240614
 */
const SchemaIn$CreateEventTypeInput20240614: z.ZodType<
  CreateEventTypeInput20240614, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$CreateEventTypeInput20240614
 */
const SchemaOut$CreateEventTypeInput20240614: z.ZodType<
  External$CreateEventTypeInput20240614, // output type of this zod object
  z.ZodTypeDef,
  CreateEventTypeInput20240614 // the object to be transformed
> = z
  .object({
    afterEventBuffer: z.number().optional(),
    beforeEventBuffer: z.number().optional(),
...
export const Schemas$CreateEventTypeInput20240614 = {
  in: SchemaIn$CreateEventTypeInput20240614,
  out: SchemaOut$CreateEventTypeInput20240614,
};
