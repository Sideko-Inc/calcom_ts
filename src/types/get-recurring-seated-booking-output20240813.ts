 ...
 */
export type GetRecurringSeatedBookingOutput20240813 = {
  absentHost: boolean;
...
/**
 * @internal
 * GetRecurringSeatedBookingOutput20240813 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$GetRecurringSeatedBookingOutput20240813 = {
  absentHost: boolean;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object GetRecurringSeatedBookingOutput20240813
 */
const SchemaIn$GetRecurringSeatedBookingOutput20240813: z.ZodType<
  GetRecurringSeatedBookingOutput20240813, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$GetRecurringSeatedBookingOutput20240813
 */
const SchemaOut$GetRecurringSeatedBookingOutput20240813: z.ZodType<
  External$GetRecurringSeatedBookingOutput20240813, // output type of this zod object
  z.ZodTypeDef,
  GetRecurringSeatedBookingOutput20240813 // the object to be transformed
> = z
  .object({
    absentHost: z.boolean(),
...
export const Schemas$GetRecurringSeatedBookingOutput20240813 = {
  in: SchemaIn$GetRecurringSeatedBookingOutput20240813,
  out: SchemaOut$GetRecurringSeatedBookingOutput20240813,
};
