 ...
 */
export type CreateRecurringBookingInput20240813 = {
  attendee: Attendee;
  /**
...
/**
 * @internal
 * CreateRecurringBookingInput20240813 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$CreateRecurringBookingInput20240813 = {
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object CreateRecurringBookingInput20240813
 */
const SchemaIn$CreateRecurringBookingInput20240813: z.ZodType<
  CreateRecurringBookingInput20240813, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$CreateRecurringBookingInput20240813
 */
const SchemaOut$CreateRecurringBookingInput20240813: z.ZodType<
  External$CreateRecurringBookingInput20240813, // output type of this zod object
  z.ZodTypeDef,
  CreateRecurringBookingInput20240813 // the object to be transformed
> = z
  .object({
...
export const Schemas$CreateRecurringBookingInput20240813 = {
  in: SchemaIn$CreateRecurringBookingInput20240813,
  out: SchemaOut$CreateRecurringBookingInput20240813,
};
