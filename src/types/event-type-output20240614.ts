 ...
 */
export type EventTypeOutput20240614 = {
  ...
  forwardParamsSuccessRedirect: Record<string, any> | null;
  ...
  seatsPerTimeSlot?: Record<string, any> | null | undefined;
  seatsShowAvailabilityCount?: boolean | null | undefined;
  slotInterval?: Record<string, any> | null | undefined;
  slug: string;
  successRedirectUrl: Record<string, any> | null;
  title: string;
...
/**
 * @internal
 * EventTypeOutput20240614 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$EventTypeOutput20240614 = {
  afterEventBuffer?: number | undefined;
  beforeEventBuffer?: number | undefined;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object EventTypeOutput20240614
 */
const SchemaIn$EventTypeOutput20240614: z.ZodType<
  EventTypeOutput20240614, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
    ...
    forwardParamsSuccessRedirect: z.record(z.string(), z.any()).nullable(),
    ...
    seatsPerTimeSlot: z.record(z.string(), z.any()).nullable().optional(),
    seatsShowAvailabilityCount: z.boolean().nullable().optional(),
    slotInterval: z.record(z.string(), z.any()).nullable().optional(),
    slug: z.string(),
    successRedirectUrl: z.record(z.string(), z.any()).nullable(),
    title: z.string(),
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$EventTypeOutput20240614
 */
const SchemaOut$EventTypeOutput20240614: z.ZodType<
  External$EventTypeOutput20240614, // output type of this zod object
  z.ZodTypeDef,
  EventTypeOutput20240614 // the object to be transformed
> = z
  .object({
    afterEventBuffer: z.number().optional(),
    beforeEventBuffer: z.number().optional(),
...
export const Schemas$EventTypeOutput20240614 = {
  in: SchemaIn$EventTypeOutput20240614,
  out: SchemaOut$EventTypeOutput20240614,
};
