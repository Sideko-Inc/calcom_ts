...
} from "calcom_ts/types/input-attendee-address-location20240614";
import {
...
> = z
  .object({
    ...
    hostsLimit: z.number().optional(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
      teamId: "teamId",
      eventSlug: "eventSlug",
      hostsLimit: "hostsLimit",
    });
  });
...
> = z
  .object({
    ...
    hosts: z.array(Schemas$Host.in).optional(),
    ...
    locations: z
      .array(
        z.union([
          ...
          Schemas$InputOrganizersDefaultApp20240614.in,
        ]),
      )
      .optional(),
...
> = z
  .object({
    ...
    hideCalendarEventDetails: z.boolean().optional(),
    hideCalendarNotes: z.boolean().optional(),
    hosts: z.array(Schemas$Host.out).optional(),
    lengthInMinutes: z.number().optional(),
    lengthInMinutesOptions: z.array(z.string()).optional(),
    locations: z
      .array(
        z.union([
          ...
          Schemas$InputOrganizersDefaultApp20240614.out,
        ]),
      )
      .optional(),
    lockTimeZoneToggleOnBookingPage: z.boolean().optional(),
    ...
    bookingFields: z
      .array(
        z.union([
          ...
          Schemas$RadioGroupFieldInput20240614.in,
          Schemas$BooleanFieldInput20240614.in,
          Schemas$UrlFieldInput20240614.in,
        ]),
      )
      .optional(),
    bookingLimitsCount: z
...
> = z
  .object({
    ...
    bookingFields: z
      .array(
        z.union([
          ...
          Schemas$RadioGroupFieldInput20240614.out,
          Schemas$BooleanFieldInput20240614.out,
          Schemas$UrlFieldInput20240614.out,
        ]),
      )
      .optional(),
    bookingLimitsCount: z
    ...
    hideCalendarEventDetails: z.boolean().optional(),
    hideCalendarNotes: z.boolean().optional(),
    hosts: z.array(Schemas$Host.out),
    lengthInMinutes: z.number(),
    lengthInMinutesOptions: z.array(z.string()).optional(),
    locations: z
      .array(
