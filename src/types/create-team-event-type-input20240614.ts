...
import { External$Host, Host, Schemas$Host } from "./host";
import {
...
} from "./input-organizers-default-app20240614";
import {
 ...
 */
export type CreateTeamEventTypeInput20240614 = {
  /**
...
/**
 * @internal
 * CreateTeamEventTypeInput20240614 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$CreateTeamEventTypeInput20240614 = {
  afterEventBuffer?: number | undefined;
  assignAllTeamMembers?: boolean | undefined;
  beforeEventBuffer?: number | undefined;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object CreateTeamEventTypeInput20240614
 */
const SchemaIn$CreateTeamEventTypeInput20240614: z.ZodType<
  CreateTeamEventTypeInput20240614, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$CreateTeamEventTypeInput20240614
 */
const SchemaOut$CreateTeamEventTypeInput20240614: z.ZodType<
  External$CreateTeamEventTypeInput20240614, // output type of this zod object
  z.ZodTypeDef,
  CreateTeamEventTypeInput20240614 // the object to be transformed
> = z
  .object({
    afterEventBuffer: z.number().optional(),
    assignAllTeamMembers: z.boolean().optional(),
...
export const Schemas$CreateTeamEventTypeInput20240614 = {
  in: SchemaIn$CreateTeamEventTypeInput20240614,
  out: SchemaOut$CreateTeamEventTypeInput20240614,
};
