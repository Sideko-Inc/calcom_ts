 ...
 */
export type CreateSeatedBookingOutput20240813 = {
  absentHost: boolean;
...
/**
 * @internal
 * CreateSeatedBookingOutput20240813 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$CreateSeatedBookingOutput20240813 = {
  absentHost: boolean;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object CreateSeatedBookingOutput20240813
 */
const SchemaIn$CreateSeatedBookingOutput20240813: z.ZodType<
  CreateSeatedBookingOutput20240813, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$CreateSeatedBookingOutput20240813
 */
const SchemaOut$CreateSeatedBookingOutput20240813: z.ZodType<
  External$CreateSeatedBookingOutput20240813, // output type of this zod object
  z.ZodTypeDef,
  CreateSeatedBookingOutput20240813 // the object to be transformed
> = z
  .object({
    absentHost: z.boolean(),
...
export const Schemas$CreateSeatedBookingOutput20240813 = {
  in: SchemaIn$CreateSeatedBookingOutput20240813,
  out: SchemaOut$CreateSeatedBookingOutput20240813,
};
