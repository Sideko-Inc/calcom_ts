 ...
 */
export type UpdateTeamEventTypeInput20240614 = {
  /**
...
/**
 * @internal
 * UpdateTeamEventTypeInput20240614 without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$UpdateTeamEventTypeInput20240614 = {
  afterEventBuffer?: number | undefined;
  assignAllTeamMembers?: boolean | undefined;
  beforeEventBuffer?: number | undefined;
...
/**
 * Takes network data, validates it, and transforms keys to match typescript object UpdateTeamEventTypeInput20240614
 */
const SchemaIn$UpdateTeamEventTypeInput20240614: z.ZodType<
  UpdateTeamEventTypeInput20240614, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$UpdateTeamEventTypeInput20240614
 */
const SchemaOut$UpdateTeamEventTypeInput20240614: z.ZodType<
  External$UpdateTeamEventTypeInput20240614, // output type of this zod object
  z.ZodTypeDef,
  UpdateTeamEventTypeInput20240614 // the object to be transformed
> = z
  .object({
    afterEventBuffer: z.number().optional(),
    assignAllTeamMembers: z.boolean().optional(),
...
export const Schemas$UpdateTeamEventTypeInput20240614 = {
  in: SchemaIn$UpdateTeamEventTypeInput20240614,
  out: SchemaOut$UpdateTeamEventTypeInput20240614,
};
